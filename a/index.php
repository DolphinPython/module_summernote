...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_FILES['images']['name'][0])) {
        ...
        foreach ($_FILES['images']['tmp_name'] as $key => $tmp_name) {
			...
			echo $fileName = time() . "_" . basename($_FILES['images']['name'][$key]);
			echo "<br>-01-<br>";
            echo $targetFilePath = $uploadDir . $fileName;
			echo "<br>-02-<br>";
            // Check file type
            echo $fileType = strtolower(pathinfo($targetFilePath, PATHINFO_EXTENSION));
			echo " -|- ";
			echo $allowedTypes = array("jpg", "jpeg", "png");
			echo "<br>-02-<br>";
...
$images = implode(",", $imagePaths); // Convert array to string for DB
	...
	echo "<br>-3-<br>";
    echo $images = implode(",", $imagePaths); // Convert array to string (comma separated)
	echo "<br>-4-<br>";
    // Insert Query
    echo $query = "INSERT INTO layouts (lname, pname, location, hsec, sec1, content1, sec2, content2, sec3, content3, fsec, status, images) 
